...
namespace IFix.Editor
{
    ...
    {
        /// <summary> PluginPath 自定义Plugins文件夹路径时改此处 </summary>
        public const string myCorePath = "./Assets/3rd/IFix/Plugins/IFix.Core.dll";
            ...
            string corePath = myCorePath)
        {
            ...
            foreach (var assembly in injectAssemblys)
            {
                GenPatch(assembly, string.Format("{0}/{1}.dll", outputDir, assembly),
                    myCorePath, string.Format("{0}{1}.patch.bytes", patchOutputDir, assembly));
            }
#else
        ...
        public static void GenPatch(string assembly, string assemblyCSharpPath
            ...
            string corePath = myCorePath, string patchPath = "Assembly-CSharp.patch.bytes")
        {
        ...
        public static void Patch()
        {
            ...
            try
            {
                foreach (var assembly in injectAssemblys)
                {
                    ...
                    GenPatch(assembly, assembly_path, myCorePath,
