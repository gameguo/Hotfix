...
public static class CodeInjector
{
    ...
    private static void OnPostprocessBuildPlayer(BuildTarget buildTarget, string buildPath)
    {
        ...
        else if (buildTarget == BuildTarget.StandaloneOSXIntel || buildTarget == BuildTarget.StandaloneOSXIntel64)
#else
    ...
    private static void MidCodeInjectoring()
    {
        ...
        Debug.Log("Start::MidCodeInjectoring");
        ...
        {
            if (DoCodeInjectorBuild("Editor"))
            {
                _hasMidCodeInjectored = true;
            }
            else
            {
                Debug.LogWarning("CodeInjector: Failed to inject Editor build!");
            }
        }
    }
